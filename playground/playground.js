    ...
    switch (b.kind) {
      ...
      case "list": {
        const items = (b.items || []).map((it) => {
          ...
          const cls = it.checked === void 0 ? null : it.checked ? "geml-task geml-task-done" : "geml-task";
